...
## Cost Explorer
Analyse your costs by region, service, tag, and more:

https://aws.amazon.com/aws-cost-management/aws-cost-explorer/
## Trusted Advisor
Trusted Advisor gives you automated guidance for cost optimisation, detecting under-utilised instances and other areas of improvement:
...
Use AWS Accounts as an accounting and security boundary, while keeping centralised billing and security controls using AWS Organizations:
https://aws.amazon.com/organizations/

## Tagging
Tagging is a powerful way to organise and allocate costs:
...
Use Auto Scaling to use just the compute you need. No need to overprovision for peak load.
...
Use the S3 Storage Classes to optimise your storage costs:
